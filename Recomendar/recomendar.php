            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Alicia">
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
            ...
            <div class="col">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" name="apellido_amigo" class="form-control" id="apellido_amigo" placeholder="Juan">
                    </div>
                </div>
            </div>
            <div class="mb-3">
